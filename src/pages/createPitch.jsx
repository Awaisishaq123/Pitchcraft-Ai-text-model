  ...
  const handleGeneratePitch = async () => {
    ...
    try {
      ...
      try {
        ...
        console.warn(
          "⚠️ Cloudinary upload failed, using original Unsplash image:",
          err
        );
      }
...
//   // 🚀 Generate Pitch + AI Image
//   const handleGeneratePitch = async () => {
//     if (!idea.trim()) return alert("⚠️ Please enter your idea first!");
//     if (!user) return alert("⚠️ Please log in before generating a pitch!");
//     setLoading(true);
...
//         uploadedImageUrl = await uploadToCloudinary(imageBlob);
//       } catch (err) {
//         console.warn("⚠️ Cloudinary upload failed, using Unsplash image:", err);
//       }
